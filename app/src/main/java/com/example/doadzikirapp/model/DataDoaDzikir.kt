...
object DataDoaDzikir {
    ...
    fun listDzikir() : List<DoaDzikirItem> {
        // to store our data from looping
    ...
    fun listDzikirPagi() : List<DoaDzikirItem> {
        ...
        for(i in titleDzikirPagi.indices) {
            val dzikirPagi = DoaDzikirItem(
                titleDzikirPagi[i],
                arabicDzikirPagi[i],
                translateDzikirPagi[i],
            )
            dataDzikirPagi.add(dzikirPagi)
        }
    ...
    fun listDzikirPetang() : List<DoaDzikirItem> {
        ...
        for (i in titleDzikirPetang.indices) {
            val dzikirPetang = DoaDzikirItem(
                titleDzikirPetang[i],
                arabicDzikirPetang[i],
                translateDzikirPetang[i]
            )
            dataDzikirPetang.add(dzikirPetang)
        }
